...
class EventDashboard extends Component {
  ...
  state = {
    events: eventsDashboard, //objeto harcodeadoque tenemos como bbdd
    isOpen: false,
    selectedEvent: null
  }
    ...
    return (
      <Grid>
        ...
        <Grid.Column width={6}>
          ...
          {this.state.isOpen && <EventForm updateEvent={this.handleUpdateEvent} selectedEvent={selectedEvent} handleFormCancel={this.handleFormCancel} createEvent={this.handleCreateEvent}/>}
